  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <img src="img/sr-anngkor-logo.png">
        <a href="http://srangkortravel.com/">www.srangkortravel.com</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <form method="post">
          ...
          <div class="form-group has-feedback">
            <input type="text" class="form-control" name="txt_uname_email" placeholder="User Name">
